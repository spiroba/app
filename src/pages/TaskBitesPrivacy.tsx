  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      <div className="container py-8 px-4 md:px-6 max-w-4xl mx-auto">
        ...
        <h1 className="text-3xl font-bold mb-6">Политика конфиденциальности TaskSteps</h1>
        
        <div className="prose prose-lg dark:prose-invert max-w-none">
          <p className="mb-4">
            Эта Политика конфиденциальности описывает, как мы собираем, используем и раскрываем вашу информацию при использовании нашего приложения TaskSteps.
          </p>
          
          <h2 className="text-2xl font-bold mt-8 mb-4">Собираемая информация</h2>
          <p className="mb-4">
            TaskSteps - это приложение для управления задачами, которое собирает следующие данные для обеспечения работы сервиса:
          </p>
